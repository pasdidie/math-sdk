        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    # CLAUDE.md section 4: base RTP split ~65-70% basegame /
                    # ~30-35% freegame. 0.647/0.317 (of total 0.965) -> ~67/33.
                    "freegame": ConstructConditions(
                        rtp=0.317, hr=200, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(hr=3.5, rtp=0.647).return_dict(),
                },
